...
public class lab5 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@value='Continue']")).click();
		driver.findElement(By.xpath("//input[@id='input-lastname']")).sendKeys("Bhandareeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
		...
		driver.findElement(By.xpath("//input[@id='input-email']")).sendKeys("fijasi4059@ishop2k.com");

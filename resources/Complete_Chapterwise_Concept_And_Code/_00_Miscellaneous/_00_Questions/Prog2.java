...
class Prog2{
    ...
    public static void main(String args[]){
        ...
        System.out.format("Numeric form of %s :%d",romanNumber,obj.romanToInt(romanNumber));
    }  
}
/*
 Code Explanantion:
...
For cases in which the integer representations of I, X or C can be multiplied by 4 
and still be less than the integer representation of the number which follows,

...
class Prog3{
     ...
     public String longestCommonPrefix(String[] strs) {
        Arrays.sort(strs); //This will sort alphabetically(lexicographic) not by size
        String s1 = strs[0];
    ...
    public static void main(String args[]){
        ...
        System.out.println("Longest Substring :"+ obj.longestCommonPrefix(str));
